...
namespace ProvinciesBL.Model
{
    public class Statistieken
    {
        ...
        {
            ProvinciesAantalGemeentes = provincies.ToDictionary(x=>x.Naam,x=>x.Gemeentes.Count());
        ...
        public IReadOnlyDictionary<string, int> ProvinciesAantalGemeentes { get; private set; }
