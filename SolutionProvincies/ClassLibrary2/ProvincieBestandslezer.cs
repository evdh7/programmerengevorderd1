    ...
    public class ProvincieBestandslezer : IProvincieBestandslezer
    {
        private List<Provincie> Converteer(List<ProvincieDL> data)
        {
            ...
            foreach (ProvincieDL provincie in data)
            {
                ...
                {
                    //voor elk nieuw object gemeente maak een string aan van straten en voeg die toe aan de lijst
        ...
        public List<Provincie> LeesBestanden(string folder, List<string> bestandsNamen) //we gaan alle bestanden inlezen
        {
